              ...
              <div className="grid gap-8 px-1 mx-auto lg:max-w-xl md:p-4">
                ...
                <div className="grid gap-4">
                  <h1 className="mb-0 text-2xl tt">
                    <span className="tt-texto">Criar Conta</span>
                  </h1>
                  <form
                    action="/cadastro"
                    autoComplete="on"
                    method="post"
                    className="grid w-full gap-6 lg:gap-2 js-recaptcha js-clie-form"
                  >
                            ...
                            >
                              <div className="grecaptcha-logo">
                                <iframe
                                  ...
                                  src="https://www.google.com/recaptcha/enterprise/anchor?ar=1&k=6Ld0b2keAAAAADfjftpjmIFGGX34ncuMu3_ru18J&co=aHR0cHM6Ly93d3cudml2YWRyZXNzLmNvbS5icjo0NDM.&hl=pt-BR&v=V6_85qpc2Xf2sbe3xTnRte7m&size=invisible&badge=bottomleft&sa=submit&cb=bqdlypagqhnh"
                                />
                              </div>
