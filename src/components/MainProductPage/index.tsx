        ...
        <article id="conteudo" className="conteudo">
          <section itemProp="breadcrumb" className="pt-6 js-appec-escondido">
            <div className="text-xs">
              <div className="flex flex-wrap items-start justify-start w-full gap-1 text-center">
                ...
                <div>
                  <a href="/cat/2/todos-vestidos-longos">Todos Vestidos Longos</a>
                </div>
                <div className="mt-0.5">
                  <svg
                    className="w-3 h-3"
                ...
                <div>
                  <a href="/prod/2581/vestido-longo-tule-glitter-busto-plissado-fucsia">
          ...
          <section className="grid max-w-screen-md gap-8 mx-auto mt-6 overflow-visible text-sm md:gap-10 lg:mx-0 lg:max-w-none tail-prod-ver-geral">
              ...
              <div className="flex flex-col gap-8">
                <div className="relative flex-shrink-0 text-sm lg:w-full lg:col-start-2 lg:row-span-2">
                  ...
                  >
                    ...
                    <input
                      type="hidden"
                      name="dados[Produto][id]"
                      defaultValue={2581}
                      className="js-tail-comprar-produto-id"
                    />
                    <input
                      type="hidden"
                      name="dados[Carrinho][2581][sku_id]"
                      defaultValue={16435}
                      className="js-tail-comprar-sku-id"
                    />
                    <input
                      type="hidden"
                      name="dados[Carrinho][2581][sku_preco_de]"
                      defaultValue="429.90"
                      className="js-tail-comprar-sku-preco-de"
                    />
                    <input
                      type="hidden"
                      name="dados[Carrinho][2581][sku_preco]"
                      defaultValue="349.90"
                      className="js-tail-comprar-sku-preco"
                    />
                    <input
                      type="hidden"
                      name="dados[Carrinho][2581][quantidade]"
                      defaultValue={1}
                    />
                    <div className="grid gap-1 tail-prod-ver-grupo-nome">
                      ...
                      >
                        <span>Vestido Longo Tule Glitter Busto Plissado Fucsia</span>
                      </h1>
                    ...
                    <div className="grid gap-8 tail-prod-ver-grupo-precos-e-variacoes">
                        ...
                        <div className="flex flex-col gap-1 tail-etapa-preco-interno">
                          ...
                          >
                            <div className="flex items-center justify-center gap-1 lg:justify-start tail-etapa-preco-de-container js-tail-etapa-preco-de-container">
                              ...
                              >
                                <div className="hidden">
                                  ...
                                  <span className="js-tail-etapa-preco-economia-valor">80,00</span>
                                </div>
                                <div className="">
                                  <span className="js-tail-etapa-preco-economia-numero">18</span>
                                  <span className="js-tail-etapa-preco-economia-porcento">%</span>
                                  OFF
                                </div>
                              </div>
                            </div>
                            <div className="flex flex-col items-center justify-center gap-1 lg:flex-row lg:justify-start tail-etapa-preco-grupo-precos-principais">
                              ...
                              >
                                <span className="">R$ </span>
                                <span className="js-tail-etapa-preco-por-valor">349,90</span>
                              </div>
                              <div className="text-3xl font-bold lg:text-2xl tail-etapa-preco-esgotado ev-etapa-preco-esgotado escondido js-tail-etapa-preco-esgotado">
                                Esgotado
                              </div>
                              <div className="text-3xl font-bold lg:text-2xl tail-etapa-preco-privado ev-etapa-preco-privado escondido js-tail-etapa-preco-privado">
                                Consulte
                              </div>
                              <div
                            ...
                            <div className="text-green-700 flex items-center justify-center gap-1 lg:justify-start lg:items-start escondido tail-etapa-preco-avista ev-etapa-preco-avista js-tail-etapa-preco-avista">
                              ...
                              >
                                ...
                                <span className="js-tail-etapa-preco-avista-texto">à vista</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="grid gap-8 tail-prod-ver-grupo-variacoes ">
                        <div className="relative grid gap-4 overflow-visible variacoes-1 js-tail-etapa-vari-div js-prod-ver-etapa-variacao-clone">
                          ...
                          >
                            <h2 className="flex items-center gap-1 text-gray-800 pointer-events-none tail-etapa-vari-titulo js-tail-etapa-vari-titulo">
                              <div className="text-xs js-tail-etapa-vari-tipo">Tamanho:</div>
                              <div className="text-xs js-tail-etapa-vari-nome js-tail-etapa-vari-nome-1">
                                40
                              </div>
                            </h2>
                            <ul className="flex flex-wrap gap-2">
                              <li className="flex-shrink-0 flex gap-1.5 flex-wrap relative js-tail-etapa-variacao-item js-tail-etapa-comprar-topo-vari2">
                                <input
                                  ...
                                  name="variacao-2"
                                  defaultValue={16435}
                                  id="ProdVer2581Sku16435"
                                  data-vari-nome={40}
                                  data-vari-id={1005}
                                  data-vari2-id={0}
                                  data-produto-id={2581}
                                  data-sku-id={16435}
                                  data-fotos-id="2581-1005"
                                  data-preco-de="429.90"
                                  data-preco-por="349.90"
                                  data-preco-economia={80.0}
                                  data-preco-avista={0.0}
                                  data-preco-parcelado="58.32"
                                  data-economia={18}
                                  data-parcela={6}
                                  data-ponto={0}
                                  data-privado={0}
                              ...
                              <li className="flex-shrink-0 flex gap-1.5 flex-wrap relative js-tail-etapa-variacao-item js-tail-etapa-comprar-topo-vari2">
                                <div className="absolute w-16 h-px bg-gray-300 rounded-full pointer-events-none top-2/4 left-2/4 tail-etapa-variacao-vazio"></div>
                                <input
                                  type="radio"
                                  name="variacao-2"
                                  defaultValue={16436}
                                  id="ProdVer2581Sku16436"
                                  data-vari-nome={42}
                                  data-vari-id={1006}
                                  data-vari2-id={0}
                                  data-produto-id={2581}
                                  data-sku-id={16436}
                                  data-fotos-id="2581-1006"
                                  data-preco-de="429.90"
                                  data-preco-por="349.90"
                                  data-preco-economia={80.0}
                                  data-preco-avista={0.0}
                                ...
                                />
                                <label
                                  htmlFor="ProdVer2581Sku16436"
                                  className="px-1.5 h-10 grid place-content-center border border-gray-300 border-solid rounded-lg cursor-pointer ev-prod-ver-variacao-label tail-prod-ver-variacao-label tail-prod-ver-variacao-texto js-tail-etapa-variacao-label js-tail-etapa-variacao-label-texto text-gray-500 bg-gray-100 ev-etapa-variacao-vazio"
                                >
                                  42
                                </label>
                              </li>
                          ...
                          <div
                            data-sku-id={16436}
                            className="px-3 py-2 font-bold text-center text-red-600 rounded-lg bg-red-50 w-max escondido tail-pers-divs-esgotado tail-pers-divs js-tail-pers-divs"
                          >
                            <div className="border-t border-b border-transparent border-solid">
                              Esgotado
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="grid gap-4 tail-prod-ver-grupo-comprar">
                      <div className="flex gap-2 tail-etapa-comprar js-tail-etapa-comprar w-full lg:max-w-xs">
                        ...
                        <a
                          href="/login"
                          className="relative flex-grow py-3 text-base tracking-wide text-center text-white transition-opacity bg-black border-none rounded-lg select-none outline-none hover:opacity-70 escondido ev-etapa-comprar-btn-privado js-tail-etapa-comprar-btn-privado"
                        >
                          Consulte
                        </a>
                        <button
                ...
                <div>
                  ...
                  <details className="border-t border-gray-300 border-solid tail-prod-ver-details">
                    ...
                    >
                      <div>
                        <p>
                          VESTIDO LONGO TULE GLITTER BUSTO PLISSADO - Vestido longo com tecido tule
                          e possui glitter para dar um charme e glamour! A cima possui o busto e
                          cintura plissada com alças reguláveis! Interno da saia possui um forro e
                          uma fenda!
                        </p>
                        <p>
                          <i>
                            Obs: Talvez as cores tenham uma leve alteração de acordo com a
                            configuração de tela que você esteja utilizando. Mas nosso compromisso é
                            enviar até você exatamente a cor que você escolher aqui no site.
                          </i>
                        </p>
                        <p>
            ...
            <section
              ...
              className="overflow-visible border-t border-solid border-gray-300 pt-8 px-2 md:pt-10 tail-prod-ver-avaliacao prod-ver-secao prod-ver-avaliacao-vazio hidden"
            >
            ...
            <div data-prod-id={2581} className="escondido js-tail-visualizado">
              <section className="relative flex items-center gap-2 overflow-hidden tail-listagem-prod js-tail-listagem-prod">
                <button
                  aria-label="Voltar Slider para os produtos anteriores"
                  className="absolute left-0 z-10 p-2 pl-0.5 tail-listagem-seta tail-listagem-prod-seta"
                ...
                <ul className="flex flex-grow ml-2 overflow-x-scroll tail-listagem-prod-slider-container js-tail-listagem-prod-lista flex flex-grow ml-2 gap-y-2">
                  <li
                    className="relative flex flex-col border border-gray-300 border-solid rounded-lg cursor-pointer tail-listagem-prod-item ev-listagem-prod-item js-tail-listagem-prod-item js-tail-paginacao-busca-item flex-shrink-0 mr-2 tail-listagem-card-largura-2 md:tail-listagem-card-largura-3 lg:tail-listagem-card-largura-4 2xl:tail-listagem-card-largura-4"
                    data-seta-posicao="direita"
                  >
                    <a
                      href="/prod/2581/vestido-longo-tule-glitter-busto-plissado-fucsia"
            ...
            <section
              className="grid gap-2 pt-6 border-t border-gray-300 border-solid md:pt-10 escondido tail-prod-ver-visualizado js-tail-visualizado-exibicao"
              data-url={0}
            >
              <h3 className="px-2 text-xl">Seu histórico de navegação</h3>
              <section className="relative flex items-center gap-2 overflow-hidden tail-listagem-prod js-tail-listagem-prod">
                <button
                  aria-label="Voltar Slider para os produtos anteriores"
                  className="absolute left-0 z-10 p-2 pl-0.5 tail-listagem-seta tail-listagem-prod-seta"
                ...
                <ul className="flex flex-grow ml-2 overflow-x-scroll tail-listagem-prod-slider-container js-tail-listagem-prod-lista flex flex-grow ml-2 gap-y-2"></ul>
                <button
                  aria-label="Avançar Slider para os próximos produtos"
                  className="absolute right-0 p-2 pr-0.5 tail-listagem-seta tail-listagem-prod-seta"
                  // onclick="listagemSlider('avancar')"
            ...
            <div
              ...
              className="relative sticky z-10 flex gap-1 inset-x-0 bottom-0 px-2.5 py-3 overflow-visible bg-white border-t border-gray-300 border-solid md:hidden tail-etapa-comprar-btn-flutuante js-tail-etapa-comprar-btn-flutuante escondido"
            >
              <button
              ...
              <a
                href="/login?redir=%2Fprod%2F2581"
